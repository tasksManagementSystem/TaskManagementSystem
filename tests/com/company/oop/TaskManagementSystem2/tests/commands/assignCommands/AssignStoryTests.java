...
public class AssignStoryTests {
    ...
    public void before() {
        ...
        this.assignStoryCommand = new AssignStoryCommand(repository);
    ...
    public void should_ThrowException_When_ArgumentCountDifferentThanExpected() {
        // Arrange
        List<String> params = TestUtilities.getList(TaskBaseConstants.EXPECTED_NUMBER_OF_ARGUMENTS_FOR_ASSIGN_STORY - 1);
