...
//
//        return String.valueOf(board.getActivityHistory().add((String.format(FEEDBACK_RATING_CHANGED, feedbackToChange.getId(), board.changeFeedback(feedbackToChange), rating))));
//
//    }
//
